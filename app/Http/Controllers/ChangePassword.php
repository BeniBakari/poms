    ...
    public function change(Request $request){
        ...
        else if(\Hash::check($request->currentpassword,Auth::user()->password))
        {
            ...
            if(!\Hash::check($request->password,Auth::user()->password))
            {
                ...
                {
                    return redirect('request')->with('success','Password Successfully changed!');
                }
                else {
                ...
                return redirect()->back()->with('information','Current and new password can not be the same!!');
            }
        }
        else {
                return redirect()->back()->with('information','Incorrect current password!');  
        }
    }
